$(function(){
    ...
    test("deserialize unsafe malice", function() {
        expect(2);
        var malice1 = "{goober:(function(){alert('malice!');})}",
            malice2 = (function(){ return $.str.encodeBase64("(function(alert('malice!'))()"); })();

        ok($.isFunction($.json.deserialize.unsafe(malice1).goober));
        deepEqual($.json.deserialize.unsafe(malice2), $.str.encodeBase64("(function(alert('malice!'))()"));
    });
});
